...
int main() {
  ...
  if (ncclSaiDenseP2pCrossEpochAllowed(false, false) ||
      ncclSaiDenseP2pCrossEpochAllowed(false, true) ||
      ncclSaiDenseP2pCrossEpochAllowed(true, true) ||
      !ncclSaiDenseP2pCrossEpochAllowed(true, false)) {
